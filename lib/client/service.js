...
var Service = /** @class */ (function () {
    ...
    Service.prototype.buildStubMethod = function (methodMeta) {
        ...
        this.handle[methodName] = function (argument, callback) {
            if (typeof argument === 'function' && !callback) {
                callback = argument;
                argument = undefined;
            }
            return _this.startCall(methodMeta, argument, callback);
        };
    };
    Service.prototype.startCall = function (methodMeta, argument, callback) {
        var _this = this;
